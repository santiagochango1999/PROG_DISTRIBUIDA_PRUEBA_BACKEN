                ...
                new ServiceOptions()
                        ...
                        .setTags(
                                List.of("traefik.enable=true",
                                        "traefik.http.routers.cliente.rule=PathPrefix(`/cliente`)",
                                        "traefik.http.routers.cliente.middlewares=cliente",
                                        "traefik.http.middlewares.cliente.stripPrefix.prefixes=/cliente"
                                )
                        )
                        .setCheckOptions(
                                new CheckOptions()
