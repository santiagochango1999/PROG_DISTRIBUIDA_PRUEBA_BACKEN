...
@ApplicationScoped
public class OrdenComprasLifeCycle {
                ...
                new ServiceOptions()
                        ...
                        .setTags(
                                List.of("traefik.enable=true",
                                        "traefik.http.routers.orden.rule=PathPrefix(`/orden`)",
                                        "traefik.http.routers.orden.middlewares=orden",
                                        "traefik.http.middlewares.orden.stripPrefix.prefixes=/orden"
                                )
                        )
                        .setCheckOptions(
                                new CheckOptions()
